...
class _homeState extends State<home> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Calculator" , style: TextStyle(color: Colors.black,fontSize: 25, fontFamily: "Times new roman") ),
        centerTitle: true,
      ),
          ...
          ,Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                }, child: Text("C", style: TextStyle(color: Colors.black,fontSize: 25, ) ,), ),
                ...
                }, child: Icon(Icons.backspace_outlined, color: Colors.black, size: 25,)),
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                }, child: Text("00", style: TextStyle(color: Colors.black,fontSize: 20, ) ,)),
